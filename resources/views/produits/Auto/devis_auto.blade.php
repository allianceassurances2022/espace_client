                                        ...
                                        <div class="panel-heading panel-heading-divider">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="text" name="usage" value="{{$usage}}" class="form-control" readonly>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="text" name="dure" value="{{$dure}}" class="form-control" readonly>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="text" name="formule" value="{{$formule}}" class="form-control" readonly>
                                                  </div>
                                              </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="text" name="assistance" value="{{$assistance}}" class="form-control" readonly>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="date" name="date_taxe" value="{{$date_taxe}}" class="form-control" readonly>
                                                  </div>
                                              </div>
                                              @endif
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="text" name="matricule" value="{{$matricule ?? ''}}" class="form-control" required>
                                                  </div>
                                              </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="col-sm-9">
                                                      <input type="text" name="marque" value="{{$marque ?? ''}}" class="form-control" required>
                                                  </div>
                                              </div>
