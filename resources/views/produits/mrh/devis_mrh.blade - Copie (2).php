            ...
            <div class="card-body p-0">
             ...
             <div class="input-group">
               ...
               <div class="col-md-4">
                ...
                @if( (isset($habitation)) && $habitation  ==="individuelle")
                <label>
                ...
                @if( (isset($habitation)) && $habitation  ==="collective")
               <label>
             ...
             <div class="col-md-4">
              ...
              @if( (isset($juredique)) &&  $juredique ==="proprietaire")
              <label>
              ...
              @if( (isset($juredique)) && $juredique ==="locataire")
              <label>
