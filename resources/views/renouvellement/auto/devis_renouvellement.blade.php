            ...
            <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    <div class="col-md-12 fuelux">
                        ...
                        <form action="{{route('validation_devis_renouvellement_auto')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="date_conducteur" value="{{auth()->user()->date_naissance ?? ''}}"
                                               class="form-control" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="wilaya" value="{{$wilaya_obtention ?? ''}}"
                                               class="form-control" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" name="dure" value=" 1année'" class="form-control" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text_affiche" name="dure_affiche"
                                               ...
                                               class="form-control" readonly>
                                        <input type="hidden" name="taxe" value="oui" class="form-control" readonly>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="valeur" name="valeur_estime" value="200 000 000 DA" class="form-control valeur"
                                        readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="num_chassis" name="num_chassis" value="{{ $num_chassis ?? ''}}"
                                               class="form-control" maxlength="17" required readonly>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="mmarque" value="{{$marque_selected ?? ''}}" class="form-control"
                                               required readonly>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="wilaya_obtention" value="{{$wilaya_obtention ?? ''}}"
                                               class="form-control" required readonly>
                                    </div>
                                </div>
