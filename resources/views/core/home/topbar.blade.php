                  ...
                  <li>
                    <div class="list">
                      <div class="content">
                        ...
                        <div class="row">
                          <div class="col-xs-12"><a href="{{route('type_produit',['catnat','index'])}}" class="connection-item"><img src="{{asset('produit_assets/images/icons/cat_nat_col.svg')}}" alt="Catastrophe Naturelle"><span>CATNAT</span></a></div>
